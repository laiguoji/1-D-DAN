...
class KimNet(nn.Module):
    ...
    def forward(self, x):
        ...
        max_pool0 = F.max_pool1d(conv0_att, 2, 2)

        conv1 = self.basic_conv1(max_pool0)
        conv0_cat1avg = F.avg_pool1d(conv0_att, 2, 2)
        ...
        conv0_cat2avg = F.avg_pool1d(conv0_att, 4, 4)
        conv0_cat2max = F.max_pool1d(conv0_att, 4, 4)
